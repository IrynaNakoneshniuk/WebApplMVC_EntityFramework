...
namespace WebApplMVC_EntityFramework.Controllers
{
    public class BooksController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int ?id, [Bind("N,Code,New,Name,Price,Izd,Pages,Format,Date,Pressrun,Themes,Category")] Book book)
        {
            if (id != book.N)
            {
                return NotFound();
        ...
        {
          return (_context.Books?.Any(e => e.N == id)).GetValueOrDefault();
        }
    }
}
